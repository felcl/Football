  ...
  return (
    <div>
      <div className="Edition-Center">
        {/* 我的交易记录 */}
        <MyDealRecord
          isShow={showOrderRecord}
          close={() => {
            setShowOrderRecord(false);
          }}
        ></MyDealRecord>
        {/* 卡牌详情 */}
        ...
        {/* 取消挂卖成功 */}
        <Tips
          isShow={showCancelSuccess}
          title="取消成功"
          subTitle="该挂卖以成功取消"
          close={() => setShowCancelSuccess(false)}
        ></Tips>
        {/* 取消挂卖 */}
        {orderInfo && (
          <CancelPurchase
            isShow={showCancelOrder}
            buyInfo={orderInfo}
        ...
        {/* 购买成功 */}
        <Tips
          isShow={showBuySuccess}
          title="购买成功"
          subTitle="购买成功以放置宝箱"
          close={() => setShowBuySuccess(false)}
        ></Tips>
        {/*确认购买  */}
        {orderInfo && (
          <MarketDealing
            ...
            buyInfo={orderInfo}
            close={() => {
              setShowEnterBuy(false);
            }}
            buySuccess={() => setShowBuySuccess(true)}
          ></MarketDealing>
        )}
        {/* 卡牌详情 */}
        <div className="SwapTitle">交易市場</div>
